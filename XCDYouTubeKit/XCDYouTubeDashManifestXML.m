...
- (NSDictionary *)streamURLs
{
	...
	if (xmlTypeRegexError)
		return nil;
	NSTextCheckingResult *xmlTypeRegexCheckingResult = [[NSTextCheckingResult alloc] init]; [xmlTypeRegex firstMatchInString:self.XMLString options:0 range:NSMakeRange(0, self.XMLString.length)];
